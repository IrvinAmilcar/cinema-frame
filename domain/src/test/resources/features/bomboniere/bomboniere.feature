...
Funcionalidade: Gestão de inventário de insumos da bomboniere
  ...
  Cenário: Venda de combo dá baixa automática nos insumos
    Dado que existe o insumo "Milho" com 1000g em estoque e nível crítico de 200g
    E existe o insumo "Embalagem" com 50 unidades em estoque e nível crítico de 10 unidades
    E existe o produto "Pipoca Grande" com receita de 200g de "Milho" e 1 "Embalagem"
  ...
  Cenário: Notificar quando estoque atingir nível crítico
    Dado que existe o insumo "Milho" com 200g em estoque e nível crítico de 200g
    E existe o insumo "Embalagem" com 50 unidades em estoque e nível crítico de 10 unidades
    E existe o produto "Pipoca Grande" com receita de 200g de "Milho" e 1 "Embalagem"
    Quando o sistema registrar a venda do produto "Pipoca Grande"
  ...
  Cenário: Impedir venda com estoque insuficiente
    Dado que existe o insumo "Milho" com 100g em estoque e nível crítico de 50g
    E existe o insumo "Embalagem" com 50 unidades em estoque e nível crítico de 10 unidades
    E existe o produto "Pipoca Grande" com receita de 200g de "Milho" e 1 "Embalagem"
