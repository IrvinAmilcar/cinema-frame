...
Funcionalidade: Motor de promoções acoplado (cupons e campanhas)
  ...
  Cenário: Aplicar cupom "Leve 2 Pague 1" com 2 ingressos
    ...
    E existe um cupom "LEVE2" do tipo "LEVE2_PAGUE1" não cumulativo e válido
  ...
  Cenário: Aplicar desconto de parceria com cartão
    Dado que o valor total do pedido é R$ 40,00 com 2 ingressos
    E existe um cupom "CARTAO10" do tipo "PARCERIA_CARTAO" não cumulativo e válido
    Quando o motor de promoções aplicar os cupons
  ...
  Cenário: Aplicar desconto para estudante
    Dado que o valor total do pedido é R$ 40,00 com 2 ingressos
    E existe um cupom "ESTUDANTE" do tipo "DESCONTO_ESTUDANTE" não cumulativo e válido
    Quando o motor de promoções aplicar os cupons
  ...
  Cenário: Permitir dois cupons cumulativos no mesmo pedido
    Dado que o valor total do pedido é R$ 40,00 com 2 ingressos
    E existe um cupom "CARTAO10" do tipo "PARCERIA_CARTAO" cumulativo e válido
    E existe um cupom "ESTUDANTE" do tipo "DESCONTO_ESTUDANTE" cumulativo e válido
    Quando o motor de promoções aplicar os cupons
  ...
  Cenário: Rejeitar cupom expirado
    Dado que o valor total do pedido é R$ 40,00 com 2 ingressos
    E existe um cupom "VELHO" do tipo "PARCERIA_CARTAO" não cumulativo e expirado
    Quando o motor de promoções tentar aplicar os cupons
